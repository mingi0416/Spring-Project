   ...
   <div class="container">
      ...
      <div class="row mt-5">
         <div class="col-md-6">
            ...
            <form role="form" action="/ex/rewrite" method="post"
	enctype="multipart/form-data" target="zeroFrame">
		...
		<input type="hidden" name='grpord' value="${grpord }">
		 <h6 class="section-secondary-title">Title</h6>    
            ...
            <input type="text" class="form-control"
				name='title' placeholder="제목을 입력해 주세요" style="width:100%" required>            
            </div>
             <h6 class="section-secondary-title">Writer</h6>
            <div class="form-group">
            	<input type="text"
				name="writer"  placeholder="작성자"  style="width:100%" value="${writer }" readonly>
            </div>
        ...
        <div class="form-group" id="poll">
			...
			<h3>Content</h3>
            <div class="form-group">
               <textarea class="form-control" name="content" id="exampleFormControlTextarea1" rows="10" placeholder="Example textarea" required></textarea>
            </div>
         </div>
         <div class="col-md-6">
          ...
          <button type="submit" class="btn btn-secondary" style="float:left">답글등록</button>
</form>   
